window.addEventListener('DOMContentLoaded', () => {
    ...
    userFormModal.addEventListener('submit', (event) => {
        ...
        if (formAbout.value.trim().length < 10) return alert('Give more information about yourself!')
        if (newPassword.value.trim() !== confirmPassword.value.trim()) return alert('Password not same!')
